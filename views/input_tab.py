...
class InputTab:
    ...
    def __init__(self, parent, db_connection):
        ...
        create_vegetation_tab(self.sub_notebook, self.conn,
                             {'vegetation': self.vegetation_model,
                              'event': self.survey_event_model})
        
        # アリ類データ入力タブ
        from views.input_tab_phase2 import create_ant_data_tab
        create_ant_data_tab(self.sub_notebook, self.conn,
